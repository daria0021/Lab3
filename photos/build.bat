...
gcc -std=c11 -Wall -Wextra -Werror -O2 -D_CRT_SECURE_NO_WARNINGS -c src\main.c -o main.o
if %errorlevel% neq 0 goto error

gcc -std=c11 -Wall -Wextra -Werror -O2 -D_CRT_SECURE_NO_WARNINGS -c src\image.c -o image.o
if %errorlevel% neq 0 goto error

gcc -std=c11 -Wall -Wextra -Werror -O2 -D_CRT_SECURE_NO_WARNINGS -c src\bmp.c -o bmp.o
if %errorlevel% neq 0 goto error

gcc -std=c11 -Wall -Wextra -Werror -O2 -D_CRT_SECURE_NO_WARNINGS -c src\filters.c -o filters.o
if %errorlevel% neq 0 goto error

gcc -std=c11 -Wall -Wextra -Werror -O2 -D_CRT_SECURE_NO_WARNINGS -c src\pipeline.c -o pipeline.o
if %errorlevel% neq 0 goto error

gcc -std=c11 -Wall -Wextra -Werror -O2 -D_CRT_SECURE_NO_WARNINGS -c src\cli.c -o cli.o
if %errorlevel% neq 0 goto error
